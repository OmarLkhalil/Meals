package com.example.restaurantapp.ui.detailscategory
...
class DetailsCategoryActivity : BaseActivity<ActivityDetailsCategoryBinding, DetailsCategoryViewModel>(), Navigator {
